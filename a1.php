...
if(!isset($_SESSION['ses_name']) && isset($_POST['rollno'])){
 ...
 while($disp_ques2  = mysqli_fetch_assoc($qu2)){
  ...
  foreach ($subject['name'] as $key => $value) {
    ...
    echo'<div class="col s2 m2"><a class="waves-effect waves-light btn green darken-2 modal-button" href="#theory'.$j.'" id="theory-button-'.$j.'">'.$value.'</a></div>';
  }else{
    echo'<div class="col s2 m2"><a class="waves-effect waves-light btn btn green darken-2 modal-button disabled" href="#theory'.$j.'" id="theory-button-'.$j.'">'.$value.'</a></div>';
  }
    $j++;
  }
  echo '</div>';
...
foreach ($practical_sub['name'] as $key => $value) {
  if(!$practical_sub['disabled'][$j]){
    echo'<div class="col s2 m2"><a class="waves-effect waves-light btn green darken-2 modal-button" href="#practical'.$j.'" id="practical-button-'.$j.'">'.$value.'</a></div>';
  }else{
