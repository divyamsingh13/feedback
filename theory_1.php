                ...
                if (isset($_POST['sub']))
                {
                    $prac_name='';
                     $depart=$_POST['department'];
                          ...
                          (FEEDBACK)</h5></b><br>
                          <div class='noPrint'>
                        <input type='checkbox' id='select-all-check' class='filled-in'>
                        <label for='select-all-check'>SELECT ALL</label></div>
                        ...
                        ?>  
                            ...
                            <tbody>
                               <?php echo "<tr class='noPrint dont_print' id='row".$i1."'>" ?>
                                ...
                                <?php 
                                    echo"<td><a href='complete.php?fac_id=$faculty_id&sub_id=$subject&section=$section&year=$year&type=theory&depart=$depart' class='avg'>$avg1</a></td>"; 
                                    ?>
